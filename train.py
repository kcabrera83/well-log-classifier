"""Training script for well log classification and porosity estimation models."""
...
def main():
    print("=" * 60)
    print("  WELL LOG CLASSIFIER - MODEL TRAINING")
    ...
    print("\n[3/5] Training lithology classifier (RandomForest + GradientBoosting)...")
    ...
    # Train porosity estimator
    print("\n[4/5] Training porosity estimator (GradientBoosting)...")
    y_porosity = df["density_porosity"].values
    y_p_train, y_p_test = y_train, y_test
    # Create porosity targets aligned with the same split
